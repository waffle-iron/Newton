...
from newton.settings import STATIC_URL
#from newton.utils import get_temperatures, get_wind_speed, get_str_days,\
...
pdfmetrics.registerFont(
    TTFont('FreeSansBold', 'static/fonts/FreeSansBold.ttf'))
...
class PdfPrint:
    ...
    # This function has to create a PDF For each student in a class.
    # It will go through the students
    def recommendation_list(self, student, title):
        ...
        table_data.append([
            ...
            Paragraph('Done?', styles['TableHeader']),
        ])
        # Go through the recommendation list for one student,
        for wh in recommended_skill_list:
