!function (t) {
    ...
    i.defaults = {
        ...
        this.$tabs = this.$element.children("li.has-submenu"), this.$tabs.children("[data-submenu]").addClass("first-sub"), this.$submenus = this.$element.find("li.has-submenu"), this.$menuItems = this.$element.find("li").attr({
            ...
            t.attr({
                role: "menuitem",
                tabindex: 0,
                title: t.children("a:first-child").text()
        ...
        var n = this;
        this.options.clickOpen && i.off("click.zf.dropdownmenu").on("click.zf.dropdownmenu", function (t) {
            e(this).hasClass("is-dropdown-submenu-parent") && (t.preventDefault(), t.stopPropagation(), i.data("isClick") ? n._hide(i) : (n._hideOthers(i), n._show(i), i.data("isClick", !0).parentsUntil("[data-dropdown-menu]", ".is-dropdown-submenu-parent").data("isClick", !0), n.options.closeOnClick && n._addBodyHandler()))
    ...
    i.defaults = {
        ...
        t.length ? e.onImagesLoaded(t, this._prepareForOrbit.bind(this)) : this._prepareForOrbit(), this.options.bullets && this._loadBullets(), this._events(), this.options.autoPlay && this.geoSync(), this.options.accessible && this.$wrapper.attr("tabindex", 0)
    ...
    "use strict";
    function i(n, s) {
        this.$element = t(n), this.options = t.extend({}, i.defaults, s), this._init(), this._events(), e.registerPlugin(this)
    }
...
}(jQuery, window.document, window.Foundation), function (t, e) {
    ...
    function e(e, o, a, r) {
        ...
        if (o = t(o).eq(0), o.length) {
            if (null === s)return e ? o.show() : o.hide(), void r();
            var h = e ? i[0] : i[1], u = e ? n[0] : n[1];
            d(), o.addClass(a), o.css("transition", "none"), requestAnimationFrame(function () {
                o.addClass(h), e && o.show()
            }), requestAnimationFrame(function () {
                o[0].offsetWidth, o.css("transition", ""), o.addClass(u)
    ...
    var i = ["mui-enter", "mui-leave"], n = ["mui-enter-active", "mui-leave-active"], s = function () {
        var t = {
            transition: "transitionend",
            WebkitTransition: "webkitTransitionEnd",
            MozTransition: "transitionend",
        ...
        for (var i in t)if ("undefined" != typeof e.style[i])return t[i];
        return null
    }(), o = {
